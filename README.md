...
```javascript
import weibull from 'https://cdn.jsdelivr.net/gh/stdlib-js/random-strided-weibull@v0.2.2-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { ndarray } from 'https://cdn.jsdelivr.net/gh/stdlib-js/random-strided-weibull@v0.2.2-esm/index.mjs';
```
