...
interface Routine {
	...
	*/
	<T = unknown>( N: number, k: Collection, sk: number, lambda: Collection, sl: number, out: Collection<T>, so: number, options?: Options ): Collection<T | number>;
	...
	*/
	ndarray<T = unknown>( N: number, k: Collection, sk: number, ok: number, lambda: Collection, sl: number, ol: number, out: Collection<T>, so: number, oo: number, options?: Options ): Collection<T | number>;
}
